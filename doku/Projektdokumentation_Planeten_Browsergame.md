...
Zunächst haben wir uns auf die Gestaltung der Oberfläche konzentriert. Da die Oberfläche größtenteils unabhängig von dem Backend entwickelt werden kann, bietet es sich an damit anzufangen. In den ersten Anläufen wurden verschiedene Kommunikationsarten und Bibliotheken getestet. Die Entscheidung fiel dann auf HttpURLConnection, durch die leichte Erlernbarkeit und durch die ausführliche Dokumentation. 
